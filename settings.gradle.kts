...
include(":android:ui:list")
include(":android:ui:login")
include(":android:ui:month")
include(":android:ui:onboarding")
include(":android:ui:operation")
include(":android:ui:settings")
include(":android:ui:year")
